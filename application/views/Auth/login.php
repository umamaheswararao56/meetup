 <?php $this->load->view('participant/header');?>
 <!-- container --> 
  <section class="showcase">
    <div class="container">
      ...
      <form action="<?php print site_url();?>par/doLogin" class="remember-login-frm" id="remember-login-frm" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        ...
        <!--Form with header-->
            <div class="card border-info rounded-0">
                <div class="card-body p-3">                
                    ...
                    <span><b>Note:</b>username: <code>demo@web.com</code> password: <code>demo1234</code></span>
                </div>
            </div> 
          </div>
        </div>
 ...
 <?php $this->load->view('participant/footer');?>        
